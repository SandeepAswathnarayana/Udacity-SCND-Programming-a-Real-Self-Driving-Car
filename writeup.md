...
- You can find the State-of-the-Art Models in Object Detection at [paperswithcode.com](https://paperswithcode.com/task/object-detection). I decided to choose Faster R-CNN based on its performance meeting the requirements for 'accuracy' as opposed to 'speed' in the object detection process. Moreover, TensorFlow hasn't kept abreast with the SOTA models by adding the same to its TensoFlow Object Detection API repository.  
